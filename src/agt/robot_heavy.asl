// Generic heavy robot agent.
// This file is kept as a heavy robot template.
// The running MAS uses robot_heavy_1 and robot_heavy_2.

agent_id(robot_heavy).
max_weight(100).
max_size(2,3).
state(idle).
...
+!go_inbound : true <- move_to(0, 0).
+!go_outbound : true <- move_to(19, 14).
